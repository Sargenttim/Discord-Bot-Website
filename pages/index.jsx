      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  ...
                  <p classname="text-md text-white font-medium text-gray-500 line-clmp-5">From advanced moderation features to music playback and everything in between, CubeCloud helps you build an engaging and well-managed community.</p>
                  <p classname="text-md text-white font-medium text-gray-500 line-clmp-5">Are you ready to unlock the full potential of your server? CubeCloud is here to make it happen.</p>
                </div>
